...
export function MinimalSelectionTest() {
  ...
  useEffect(() => {
    console.log(
      'MinimalTest - selectedItems changed:',
  ...
  const toggleSelection = id => {
    ...
    console.log(
      'MinimalTest - current selectedItems:',
      JSON.stringify(selectedItems)
    );

    setSelectedItems(prev => {
      console.log(
        'MinimalTest - inside setSelectedItems, prev:',
        JSON.stringify(prev)
      );
      ...
      if (isSelected) {
        ...
        console.log(
          'MinimalTest - removing, newSelection:',
          JSON.stringify(newSelection)
        );
      } else {
        newSelection = [...prev, id];
        console.log(
          'MinimalTest - adding, newSelection:',
          JSON.stringify(newSelection)
        );
      }
...
export class MinimalSelectionConsoleTest {
  ...
  static runAllTests() {
    ...
    console.log('='.repeat(60));
    console.log(
      `React State Management: ${stateTest ? '✅ WORKING' : '❌ BROKEN'}`
    );
    console.log(
